...
export async function registerPortingPrompts(server) {
    server.prompt("analyze-python-file", "Generate a prompt to analyze a Python file for porting complexity and recommendations.", {
...
7. Testing strategy for validation`
    ...
    server.prompt("review-typescript-conversion", "Generate a prompt to review a TypeScript conversion of Python code.", {
...
//# sourceMappingURL=porting-prompts.js.map